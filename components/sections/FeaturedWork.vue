...
const projects = computed(() => [
  ...
  {
    slug: 'cruzar-deportes',
    title: 'Cruzar Deportes',
    description: t('featuredWork.cruzarDeportes.description'),
    image: '/assets/images/cruzar-deportes.png',
    imageWebp: '/assets/images/cruzar-deportes.webp',
    url: 'https://cruzardeportes.com',
    width: 2880,
    height: 1870,
  },
  {
  ...
  },
  {
    ...
    image: '/assets/images/text-the-check.png?v=3',
    imageWebp: '/assets/images/text-the-check.webp?v=3',
